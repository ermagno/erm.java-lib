...
public class ESCtrlPK extends ESCtrl {
...
//			secondRow.add(content.get(content.size()-1) , c);
	...
	protected void configureActions() {
		...
		actOpenAna = new ESActionOpenAna(table, ESCtrlPK.this);
		actSelection = new ESActionSearch(table, this, false);
...
//		        t.setEditable(id <= 0);
	...
	public void setValue(Object value) {
	    table.getIdField().setValue(value);
	    loadValue();
	}
